...
namespace Covoiturage.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, Nom = model.Nom, Prenoms = model.Prenoms,
                                                DateNaiss = model.DateNaiss, Adresse = model.Adresse, PhoneNumber = model.Num};
